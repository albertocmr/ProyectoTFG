            ...
            <div class='container'>
                <div class='row'>
                    <div class='col-sm-12 col-md-6 col-lg-7 rounded border border-black'>
                        ...
                        <p> En esta página web puedes consultar si la ruta que tienes pensado hacer incumple con las restricciones ambientales que contienen los parques naturales que atraviesa tu trayecto </p>
                    </div>
